...
internal static class SettingsWindow
{
	...
	private static void DrawMiscConfig()
	{
		...
		ImGuiHelper.ToolTip("This limits the entity reading algorithm to a set number of CPUs. Select -1 to disable this limit. Use Task Manager CPU usage stat + Misc Tools -> performance stats to figure out best FPS to CPU usage ratio.");
		ImGui.SameLine();
