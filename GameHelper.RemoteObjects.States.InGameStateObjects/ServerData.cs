...
public class ServerData : RemoteObjectBase
{
	...
	protected override void UpdateData(bool hasAddressChanged)
	{
		...
		InventoryArrayStruct[] inventoryData = handle.ReadStdVector<InventoryArrayStruct>(handle.ReadMemory<ServerDataStructure>(base.Address + 44288).PlayerInventories);
		PlayerInventories.Clear();
