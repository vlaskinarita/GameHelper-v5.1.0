...
public class ImportantUiElements : RemoteObjectBase
{
	...
	public UiElementBase NecropolisMonsterWindow { get; }
		...
		: base(address)
	{
		...
		NecropolisMonsterWindow = new UiElementBase(IntPtr.Zero, rootCache);
	...
	internal override void ToImGui()
	{
		...
		ImGui.Text($"Necropolis Monster Window Visible: {NecropolisMonsterWindow.IsVisible}");
	...
	protected override void CleanUpData()
	{
		...
		NecropolisMonsterWindow.Address = IntPtr.Zero;
	...
	protected override void UpdateData(bool hasAddressChanged)
	{
		...
		ImportantUiElementsOffsets data1 = reader.ReadMemory<ImportantUiElementsOffsets>(Core.GHSettings.IsTaiwanClient ? (base.Address - 8) : base.Address);
		...
		else
		{
			...
			NecropolisMonsterWindow.Address = data1.NecropolisMonsterPanel;
